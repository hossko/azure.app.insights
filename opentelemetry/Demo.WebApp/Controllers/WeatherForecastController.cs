...
namespace Demo.WebApp.Controllers
{
    ...
    {   
        ...
        {
            _logger.LogInformation(2001, "INFO TRACING DEMO: WebApp API weather forecast request forwarded");
            _logger.LogWarning(2001, "WARN TRACING DEMO: WebApp API weather forecast request forwarded");
            _logger.LogCritical(2001, "CRT TRACING DEMO: WebApp API weather forecast request forwarded");
